# Generated by Powerlevel10k configuration wizard on 2020-08-27 at 13:55 CEST.
...
() {
  ...
  #     '*'            DEFAULT  '')
  #
  # Whenever the current directory is $HOME/work or a subdirectory of $HOME/work, it gets styled with class
